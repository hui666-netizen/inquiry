...
import { Memory, createLocalStorage, createSessionStorage } from '@sjzy/utils'
import type { REMEMBER_KEY, ROLES_KEY } from './cacheEnum'
import { APP_LOCAL_CACHE_KEY, APP_SESSION_CACHE_KEY, TOKEN_KEY, USER_INFO_KEY } from './cacheEnum'
import { DEFAULT_CACHE_TIME } from './config'
import type { UserModuleType } from '@/types/store'

type BasicStore = {
  [TOKEN_KEY]: string | number | null | undefined
  [USER_INFO_KEY]: UserModuleType
  [ROLES_KEY]: string[]
  [REMEMBER_KEY]: string[]
}
