...
import img404 from '@/assets/error_images/404.png'
import imgCloud from '@/assets/error_images/cloud.png'
    ...
    <div class="error-content">
      <ElRow :gutter="20">
        <ElCol :lg="12" :md="12" :sm="24" :xl="12" :xs="24">
          <div class="pic-error">
            <ElImage class="pic-error-parent" :src="img404" />
            <ElImage class="left pic-error-child" :src="imgCloud" />
          </div>
        </ElCol>
