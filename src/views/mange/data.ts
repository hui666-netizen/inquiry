...
import type { VxeTableDefines } from 'vxe-pc-ui'
...
/** 咨询总列表列 */
export const mangeInquireColumn: Partial<VxeTableDefines.ColumnInfo>[] = [
  {
    field: 'inquiryNumber',
    title: '询价编号',
  },
...
/** 所有的业务员列 */
export const allSaleColumn: Partial<VxeTableDefines.ColumnInfo>[] = [
  {
    field: 'RegionName',
    title: '大区',
  },
  ...
  {
    field: 'AcceptCustomerfrequency',
    title: '接收客户次数',
  },
]

/** 业务员咨询列表列 */
export const saleInquireColumn: Partial<VxeTableDefines.ColumnInfo>[] = [
  {
    field: 'inquiryNumber',
    title: '询价编号',
  },
